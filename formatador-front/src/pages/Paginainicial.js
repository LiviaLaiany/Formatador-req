    ...
    return(
        <div>
            <div  className='vh-100 ' id='box'>
                <div className='d-flex py-3 h-25 justify-content-between w-100'>
                    <video className='d-none d-sm-block w-50 w-sm-100 video' autoPlay loop muted>
                        <source src={video1} className='w-100 h-100 'type="video/mp4"></source>

                    </video>
                    <video className=' w-50 w-sm-25 d-none d-sm-block video' autoPlay loop muted>
                ...
                <div className='d-flex h-25  justify-content-center w-100'>
                        <video className=' w-sm-25 w-75 video' autoPlay loop muted>
