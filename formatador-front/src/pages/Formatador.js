        ...
        <div className=" " style={{ backgroundColor:'#2CAEEF' }}>
            ...
            <div className='container d-flex flex-md-row min-vh-100 align-items-stretch justify-content-center gap-3'>
                <div style={{ }} className="pb-3  h-50 row container rounded my-5  ">
                    <div className="card  formatador-card mx-auto vh-auto shadow-sm p-4 bg-light rounded col-12 col-md-5" id='projeto'>
                        ...
                        <div className=" d-flex justify-content-center align-items-center h-auto w-100 ">
                            {projetos?.length === 0 ? (
                                ...
                                <div className="row d-flex justify-content-center h-100 w-100" id='card-projeto'>
                                    <strong className='fs-2 justify-content-center text-center align-items-center d-flex strong-meusProjeto'>Meus Projetos </strong>
                                            ...
                                            <div className="row container w-100 w-md-auto p-0 p-md-0 justify-content-center align-items-center">
                                                ...
                                                <div className="col-12 col-sm-6 col-md-4 col-lg-3 p-0 p-md-auto align-items-center flex-column d-flex justify-content-center w-100">
                                                    <div id='' className="cardPastaModelo card formatador-card shadow-sm align-items-center pb-3 justify-content-center p-0 h-100 w-100">
                                                        ...
                                                        <div className='row'>
                                                            <div className=' w-auto' id='texto-fluido-formatador'>
                                                                {projeto?.descricao}
                                                            </div>
                                                        </div>

                                                        {showButtons[projeto.id] && (
                                                            <div className="card-body formatador-card-body text-center">
                    ...
                    <div className="card formatador-card mx-auto vh-auto shadow-sm p-4 bg-light rounded col-12 col-md-5" id='modelo'>
                        ...
                        <strong className='fs-2 justify-content-center text-center align-items-center strong-meusModelos d-flex'>Meus Modelos </strong>
