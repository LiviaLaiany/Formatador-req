  ...
  return(
    <div className="row w-100 h-100 ">
      ...
      <div className="col-sm vh-100 pt-5" id="back2">
        <div className="d-flex mb-5  pt-2 justify-content-center align-items-center w-50 fs-1 fw-bold rounded-pill text-center mx-auto" id="nome" style={{ minHeight: '50px' }}>
            <p>Login</p>
        </div>
